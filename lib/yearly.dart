  ...
  void calculate() {
    ...
    if (text1.isEmpty || text2.isEmpty) {
      Fluttertoast.showToast(
          ...
          fontSize: 16.0);
    } else if (double.parse(text1) < 0 ||
        double.parse(text1) > 100 ||
        double.parse(text2) < 0 ||
        double.parse(text2) > 100) {
      Fluttertoast.showToast(
          msg: "Bal 100-dən böyük və ya 0-dan kiçik ola bilməz",
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.CENTER,
      ...
      point = (double.parse(text1) + double.parse(text2)) / 2;
          ...
          child: Center(
            child: ListView(
              ...
              Column(
                ...
                children: [
                  Row(children: [
                    const Text("1-ci yarımillik balı:",
                        style:
                  ...
                  Row(children: [
                    Container(
                      ...
                      child: const Text("2-ci yarımillik balı:",
                          style:
                              TextStyle(fontSize: 20, fontWeight: FontWeight.w500)),
                    ),
                    Flexible(
